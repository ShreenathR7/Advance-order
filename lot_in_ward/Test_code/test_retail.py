...
class Test_Logimax:
    ...
    def test_vendor_registration(self,booting_function):   
        ...
        sleep(5)
        drop_down_1 = Select (self.driver.find_element(by=By.ID,value=locators.Logi_Locators().type))
        drop_down_1.select_by_value('2')
        sleep(5)
        ...
        karigar.send_keys('SRI MURUGAN  Nagai Maligai')
        karigar.send_keys(Keys.RETURN) 
        sleep(5)
        self.driver.find_element(by=By.ID,value=locators.Logi_Locators().order_by).click()
        label = self.driver.find_element(by=By.ID,value=locators.Logi_Locators().order_by).text
        assert self.driver.title == 'Logimax Technology | Admin'
        print('Order By :'.format(a = label))
        ...
        category.send_keys('22KT GOLD ORNAMENTS')
        ...
        product.send_keys('GOLD NECKLACE')
